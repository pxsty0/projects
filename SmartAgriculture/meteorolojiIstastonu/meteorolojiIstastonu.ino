 ...
 *  Bu uygulamada Deneyap Sıcaklık Nem Basınç Ölçer, Deneyap Toprak Nemi Ölçer, Deneyap Ultraviyole Işık Algılıcı, Deneyap Yağmur Algılıcı, Deneyap Gerçek Zamanlı Saat ve Deneyap Hoparlör kullanılmıştır.
 * 
